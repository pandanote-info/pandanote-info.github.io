...
\begin{align}
P\left{XY\le z\right} &= P\left{XY\le z,Y \le 0\right} + P\left{XY\le z, Y \ge 0\right}\label{eq:Pxy}
\end{align}
...
\begin{align}
P\left{XY\le z,Y \le 0\right} &= \frac{1}{2\pi}\int^{\infty}_0 e^{-\frac{y^2}{2}}dy\int^{\frac{z}{y}}_{-\infty}e^{-\frac{x^2}{2}}dx
