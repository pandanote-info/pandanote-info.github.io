...
encoding: UTF-8
update: Fri Apr  8 09:02:21 2022 +0900
---
{% include pagelink.md %}
...
## 説明用矢印の色遣いの変更
次に、この際本Webサイト等に貼り付けている説明用の画像で使っている矢印の色を赤(#ff0000)から国鉄の色名称のうちの朱色5号(#CA4F3C,RGB:(202,79,60),以下単に「朱色5号」と書きます。)に変更することにしました。
...
NFTは配布するとしても、投げ銭や寄付として許容され、かついろいろと失敗しても文句が出ない程度の有償の金額(可能であれば暗号資産建て)での配布とする予定です。
## リンク
{% include pagelink.md %}
